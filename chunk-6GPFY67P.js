import { e as Z, g as k } from "./chunk-QE6IBIJD.js";
var ne = {};
k(ne, {
...
function D(e, t, r, n, i, o) {
  ...
  for (
    var f = n.kind,
      p = f === "getter" ? "get" : f === "setter" ? "set" : "value",
      c = !t && e ? (n.static ? e : e.prototype) : null,
      s = t || (c ? Object.getOwnPropertyDescriptor(c, n.name) : {}),
      l,
      _ = !1,
      u = r.length - 1;
    u >= 0;
    ...
    var y = {};
    for (var h in n) y[h] = h === "access" ? {} : n[h];
    ...
    } else (l = a(d)) && (f === "field" ? i.unshift(l) : (s[p] = l));
  }
...
function $(e, t, r) {
  ...
  function c(u) {
    u.value instanceof w
      ? Promise.resolve(u.value.v).then(s, l)
      : _(o[0][2], u);
  }
  function s(u) {
    p("next", u);
  ...
  function _(u, y) {
    u(y), o.shift(), o.length && p(o[0][0], o[0][1]);
  }
}
function q(e) {
  var t, r;
  ...
  function n(i, o) {
    t[i] = e[i]
      ? function (a) {
          return (r = !r) ? { value: w(e[i](a)), done: !1 } : o ? o(a) : a;
        }
      : o;
  }
}
...
function X(e) {
  function t(o) {
    (e.error = e.hasError
      ? new te(o, e.error, "An error was suppressed during disposal.")
      : o),
      (e.hasError = !0);
  }
  var r,
